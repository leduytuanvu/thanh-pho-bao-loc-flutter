            ...
            onTap: () {
              switch (title) {
                case "Full name":
                  ...
                  break;
                case "Email":
                  controller.emailTextController.text = controller.email.value;
                  break;
                case "Phone":
                  controller.phoneTextController.text = controller.phone.value;
                  break;
                case "Gender":
                  String tmp = controller
                      .user.value.gender!.genderToString.capitalizeFirstLetter;
                  tmp == "Empty"
